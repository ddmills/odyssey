...
class Inventory extends Component
{
	...
	public function new()
	{
		...
		addHandler(OpenInventoryEvent, (evt) -> onOpenInventory(cast(evt, OpenInventoryEvent)));
		addHandler(StashInventoryEvent, (evt) -> onStashInventory(cast(evt, StashInventoryEvent)));
	}
