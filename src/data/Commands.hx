...
class Commands
{
	...
	public static function Init()
	{
		...
		cmd(INPUT_DOMAIN_ADVENTURE,   CMD_MOVE_NE,   'move north east',   KEY_NUMPAD_9);
		cmd(INPUT_DOMAIN_ADVENTURE,   CMD_MOVE_W,    'move west',         KEY_NUMPAD_4);
		cmd(INPUT_DOMAIN_ADVENTURE,   CMD_MOVE_E,    'move east',         KEY_NUMPAD_6);
		cmd(INPUT_DOMAIN_ADVENTURE,   CMD_MOVE_SW,   'move south west',   KEY_NUMPAD_1);
		cmd(INPUT_DOMAIN_ADVENTURE,   CMD_MOVE_S,    'move south',        KEY_NUMPAD_2);
		cmd(INPUT_DOMAIN_ADVENTURE,   CMD_MOVE_SE,   'move south east',   KEY_NUMPAD_3);
		// @formatter:on
	}
